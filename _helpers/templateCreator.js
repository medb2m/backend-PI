...
export const templateGenerator = async (firstName, lastName, courseTitle, certificateid) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      const logoPath = path.join(__dirname, '..', 'assets', 'tmp' ,'assets', 'MegaLearnLOGO.jpg');
      const fontPathLight = path.join(__dirname, '..', 'assets', 'tmp' ,'fonts', 'NotoSansJP-Light.otf');
      const fontPathRegular = path.join(__dirname, '..', 'assets', 'tmp' ,'fonts','NotoSansJP-Regular.otf');
      const fontPathBold = path.join(__dirname, '..', 'assets', 'tmp' ,'fonts', 'NotoSansJP-Bold.otf');
      const qrPath = path.join(__dirname, '..', 'assets', 'tmp' ,'assets', 'qr.png');
      ...
      const link =
        'https://megalearn.com/verification-here';
